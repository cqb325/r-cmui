...
class Grid extends BaseComponent {
    ...
    renderHeadRow(){
        return this.state.columns.map((column, index)=>{
            ...
            return (<div key={index} className="cm-grid-column" style={style} data-column={column.name} data-index={index}>
                    <span className="cm-grid-head-text">
                        {column.text}
                        {column.sort ? <span className="cm-grid-sort" onClick={this.sortColumn.bind(this, column)}></span>: null}
                    </span>
                {column.resize ? <DraggableCore axis="x" onDrag={this.resizeColumn.bind(this, column, index)}><span className="cm-grid-resize"></span></DraggableCore>: null}
            </div>);
        });
    }
    ...
    updateSpacer(){
        ...
        let ele = ReactDOM.findDOMNode(this);
        let scroll = Dom.dom(Dom.query(".cm-grid-scroll-box", ele));
                ...
                <div className="cm-grid-box">
                    ...
                    <div className="cm-grid-scroll">
                        <div className="cm-grid-scroll-box">
                            <div className="cm-grid-scroll-spacer" ref="spacer"></div>
                        </div>
